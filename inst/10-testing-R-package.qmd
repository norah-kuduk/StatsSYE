...
```{r}
ver_quali_2022 <- get_quali_telemetry(season = 2022, round = 10, driver = "VER") |> filter(lap_number == 21)
```

```{r}
ver_quali_2023 <- get_quali_telemetry(laps = "fastest", season = 2023, round = 10, driver = "VER")
```
