...
```{r degbrazil, out.width='70%', fig.align='center', fig.cap='Plot of the seven fastest lap times and tire degradation across the two seasons.', fig.height=4}
#| echo: false
#| warning: false
#| message: false
